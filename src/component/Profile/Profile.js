...
function Profile() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.put(`https://simransinha456-ginger-media-backend.vercel.app/profile/${id}`, {
  ...
  const handleSubmit2 = async (event) => {
    ...
    try {
      ...
      const response = await axios.put(
        ...
        `https://simransinha456-ginger-media-backend.vercel.app/profile/${id}/edit`,
        {
          age,
          dob,
          contact,
